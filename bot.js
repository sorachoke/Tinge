//Designed by the Tinge development team.
...
const tingeIcon = 'https://raw.githubusercontent.com/tangerine-bot/tangerine/master/tangerine_transparent.png';
const tingeFooter = 'Tinge // tingebot.co'
const tingeVersion = ("v10");
...
client.on("ready", () => {
  console.log(`Tinge is online, with ${thousands_separators(client.users.size)} users, in ${thousands_separators(client.channels.size)} channels of ${thousands_separators(client.guilds.size)} servers.`);
  client.user.setActivity(`Tingebot.co. Use %help for help!.`, {
...
client.on('ready', () => {
  ...
  const embed = new Discord.RichEmbed()
    .setTitle(`Tinge \`${tingeVersion}\` is now online  ✅`)
    .setColor([253, 144, 43])
...
//   client.user.setActivity(`tingebot.co. 🍊 ∼help.`, {
//     type: 'WATCHING' //PLAYING, LISTENING, WATCHING
//   });
//   const embed = new Discord.RichEmbed()
...
client.on("message", async message => {
  ...
  if (message.channel.type === "dm") {
    return message.reply("Sorry, Tinge does not run in direct messages.");
  }
  //////////////////////////////////////////////////////
  ...
  if (command === "help" || command === "commands") {
    ...
    if (args.length == 0 || args[0] === 'help') {
      const embed = new Discord.RichEmbed()
        .setTitle("Tinge's commands")
        .setColor([253, 144, 43])
        .setDescription(`To view the commands in a group, use: \n\`~help <group>\``)
        .setFooter(`${tingeFooter}`, `${tingeIcon}`)
        .setTimestamp()
        //.addBlankField(false)
    ...
    if (args[0] === "general") {
      const embed = new Discord.RichEmbed()
        .setTitle("Tinge's general commands")
        .setColor([253, 144, 43])
        .setFooter(`${tingeFooter}`, `${tingeIcon}`)
        .setTimestamp()
        .addField("`help`", "prints out all of the main Tinge commands", true)
    ...
    if (args[0] === "utility") {
      const embed = new Discord.RichEmbed()
        .setTitle("Tinge's list of utility commands")
        .setColor([253, 144, 43])
        .setFooter(`${tingeFooter}`, `${tingeIcon}`)
        .setTimestamp()
    ...
    if (args[0] === "fun") {
      const embed = new Discord.RichEmbed()
        .setTitle("Tinge's list of fun commands")
        .setColor([253, 144, 43])
        .setFooter(`${tingeFooter}`, `${tingeIcon}`)
        .setTimestamp()
    ...
    if (args[0] === "minecraft") {
      const embed = new Discord.RichEmbed()
        .setTitle("Tinge's Minecraft trackers")
        .setColor([253, 144, 43])
        .setFooter(`${tingeFooter}`, `${tingeIcon}`)
        .setTimestamp()
    ...
    if (args[0] === "games") {
      const embed = new Discord.RichEmbed()
        .setTitle("Tinge's list of other game tracking commands")
        .setColor([253, 144, 43])
        .setFooter(`${tingeFooter}`, `${tingeIcon}`)
        .setTimestamp()
        .addField("💥", "**Other**")
    ...
    if (args[0] === "generation") {
      const embed = new Discord.RichEmbed()
        .setTitle("Tinge's list of random commands")
        .setColor([253, 144, 43])
        .setFooter(`${tingeFooter}`, `${tingeIcon}`)
        .setTimestamp()
    ...
    if (args[0] === "moderation") {
      const embed = new Discord.RichEmbed()
        .setTitle("Tinge's administration commands")
        .setColor([253, 144, 43])
        .setDescription("You must have special permissions to run these commands.")
        .setFooter(`${tingeFooter}`, `${tingeIcon}`)
        .setTimestamp()
  ...
  if (command === 'about') {
    ...
    const embed = new Discord.RichEmbed()
      .setTitle(`Tinge ${tingeVersion}`)
      .setColor([253, 144, 43])
      .setDescription(`Last updated ${lastUpdated}.`)
      .setFooter(`${tingeFooter}`, `${tingeIcon}`)
      .setTimestamp()
      .addBlankField(true)
      .addField("The Tinge Team", "Sorachoke#2142")
      .addField("Official Website", "[Tinge Website](https://tingebot.co)")
      .addField("Invite Link", "[Tinge Bot](https://bit.ly/tingeBot)")
  ...
  if (command === "support" || command === "ticket") {
    ...
    return message.reply("Your message has been recieved and will be looked at shortly. For additional help, please visit https://tingebot.co or run ~help.")
  }
  //////////////////////////////////////////////////////
  if (command === "list") {
    if (!(`${message.member.user.id}` === `${admin1}`) || !(`${message.member.user.id}` === `${admin1}`))
      message.reply("Sorry, this command is reserved for Tinge admin.");
